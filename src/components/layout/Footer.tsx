...
export default function Footer() {
  ...
  const socials = [
    { key: 'instagram', label: 'Instagram', href: ft.instagramUrl || 'https://www.instagram.com/_ahmedhanyy/' },
    { key: 'facebook', label: 'Facebook', href: ft.facebookUrl || 'https://www.facebook.com/ahmed.hany.39' },
    { key: 'vimeo', label: 'Vimeo', href: ft.vimeoUrl || 'https://vimeo.com/ahmedabuzenada' },
  ].filter(l => l.href);
  ...
  return (
    <footer className="footer relative overflow-hidden border-t border-white/[0.04]">
      ...
      <div className="container-main relative z-10">
        {/* ── Two-Side Layout: Left & Right ── */}
        <div className="flex flex-col md:flex-row justify-between gap-12"
          style={{ paddingTop: s.mainPaddingY + 20, paddingBottom: s.mainPaddingY + 20 }}>
          ...
          <div className="flex flex-col max-w-sm">
            ...
            <p className="text-white/35 text-sm leading-relaxed mb-6">{description}</p>
            ...
            {/* Location tag */}
            <div className="flex items-center gap-2 text-white/25 text-xs tracking-wide">
          ...
          <div className="flex gap-16 md:gap-20">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                <a href={`mailto:${email}`} className="group flex items-center gap-2.5 text-sm text-white/40 hover:text-white transition-colors duration-300">
        ...
        <div className="border-t border-white/[0.04] flex flex-col md:flex-row items-center justify-between gap-3"
          ...
          <p className="text-[11px] text-white/20 tracking-wide">© {new Date().getFullYear()} {copyrightName}. All rights reserved.</p>
          <p className="text-[11px] text-white/15 italic tracking-wide">{tagline}</p>
        </div>
      </div>
    </footer>
  );
