...
interface ContactFormProps {
  ...
  fieldGroupStyle?: React.CSSProperties;
  labelsStyle?: React.CSSProperties;
  inputsStyle?: React.CSSProperties;
  submitBtnStyle?: React.CSSProperties;
}

export default function ContactForm({ formStyle, fieldGroupStyle, labelsStyle, inputsStyle, submitBtnStyle }: ContactFormProps) {
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="form-field-group" style={fieldGroupStyle}>
            <label className={`form-field-label ${focusedField === 'name' ? 'active' : ''}`} style={labelsStyle}>
          ...
          <div className="form-field-group" style={fieldGroupStyle}>
            <label className={`form-field-label ${focusedField === 'email' ? 'active' : ''}`} style={labelsStyle}>
        ...
        {/* Subject */}
        <div className="form-field-group" style={fieldGroupStyle}>
          <label className={`form-field-label ${focusedField === 'subject' ? 'active' : ''}`} style={labelsStyle}>
        ...
        {/* Message */}
        <div className="form-field-group" style={fieldGroupStyle}>
          <label className={`form-field-label ${focusedField === 'message' ? 'active' : ''}`} style={labelsStyle}>
